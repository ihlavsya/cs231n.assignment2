...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W1'] = np.random.normal(loc=0, scale=weight_scale, size=w1_shape)
        self.params['b1'] = np.zeros((num_filters,), dtype=np.float64)
        pool_height = 2
        stride = 2
        H_pool_out = 1 + (H - pool_height) // stride
        input_w_dim = num_filters * H_pool_out * H_pool_out
        self.params['W2'] = np.random.normal(loc=0, scale=weight_scale, size=(input_w_dim, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dx_affine, grads['W3'], grads['b3'] = affine_backward(dout, affine_cache)
        dx_affine_relu, grads['W2'], grads['b2'] = affine_relu_backward(dx_affine, affine_relu_cache)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dx_affine_relu, conv_relu_pool_cache)
